...
5. Open the app, go to **Settings**, choose **OAuth or GitHub App**, and save the GitHub Client ID, Client Secret, application URL, and session secret.
...
- If a branch already exists, GitHub will reject branch creation. Choose a fresh branch name.